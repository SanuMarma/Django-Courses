...
class contactForm(forms.Form):
    ...
    appointment = forms.CharField(widget=forms.NumberInput(attrs= {'type' : 'datetime-local'}))
...
class StudentData(forms.Form):
    ...
    file = forms.FileField(validators=[validators.FileExtensionValidator(allowed_extensions=['pdf', 'png', 'jpg'], message= 'File Extension must be ended with .pdf')])
